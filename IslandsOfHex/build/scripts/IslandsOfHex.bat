...
@rem Add default JVM options here. You can also use JAVA_OPTS and ISLANDS_OF_HEX_OPTS to pass JVM options to this script.
...
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %ISLANDS_OF_HEX_OPTS%  -classpath "%CLASSPATH%" islands.GameDriver %*
